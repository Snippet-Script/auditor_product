...
export default function Contacts() { return <Page title="Contacts" desc="Manage recipient lists, segments, suppression." nextTo="/schedule" nextLabel="Next: Schedule" /> }
  ...
  return (
    <div style={{ maxWidth:860 }}>
      ...
      <div style={{ padding:24, background:'#222', border:'1px solid #333', borderRadius:8, display:'flex', flexDirection:'column', gap:20 }}>
        <p style={{ margin:0 }}>Placeholder for contacts table & segmentation filters.</p>
