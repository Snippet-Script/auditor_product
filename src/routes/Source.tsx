...
export default function Source() { return <Page title="Source" desc="Provide script, assets, references or external feeds." nextTo="/content" nextLabel="Next: Content" /> }
  ...
  return (
    <div style={{ maxWidth:860 }}>
      ...
      <div style={{ padding:24, background:'#222', border:'1px solid #333', borderRadius:8, display:'flex', flexDirection:'column', gap:20 }}>
        <p style={{ margin:0 }}>Placeholder for {title} inputs (upload boxes, URL fields, etc.).</p>
