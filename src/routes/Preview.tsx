...
export default function Preview() { return <Page title="Preview" desc="Final rendering & QA before sending." nextTo="/contacts" nextLabel="Next: Contacts" /> }
  ...
  return (
    <div style={{ maxWidth:860 }}>
      ...
      <div style={{ padding:24, background:'#222', border:'1px solid #333', borderRadius:8, display:'flex', flexDirection:'column', gap:20 }}>
        <p style={{ margin:0 }}>Placeholder for live HTML/email preview + device modes.</p>
