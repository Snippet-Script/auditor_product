...
export default function Content() { return <Page title="Content" desc="Draft, edit and enrich newsletter content blocks." nextTo="/design" nextLabel="Next: Design" /> }
  ...
  return (
    <div style={{ maxWidth:860 }}>
      ...
      <div style={{ padding:24, background:'#222', border:'1px solid #333', borderRadius:8, display:'flex', flexDirection:'column', gap:20 }}>
        <p style={{ margin:0 }}>Placeholder for block editor integration.</p>
