...
export default function Design() { return <Page title="Design" desc="Layout, styles, theming and visual adjustments." nextTo="/preview" nextLabel="Next: Preview" /> }
  ...
  return (
    <div style={{ maxWidth:860 }}>
      ...
      <div style={{ padding:24, background:'#222', border:'1px solid #333', borderRadius:8, display:'flex', flexDirection:'column', gap:20 }}>
        <p style={{ margin:0 }}>Placeholder for design system controls and canvas.</p>
