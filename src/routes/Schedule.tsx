...
export default function Schedule() { return <Page title="Schedule" desc="Configure send time, throttling & approvals." nextTo="/analytics" nextLabel="Next: Analytics" /> }
  ...
  return (
    <div style={{ maxWidth:860 }}>
      ...
      <div style={{ padding:24, background:'#222', border:'1px solid #333', borderRadius:8, display:'flex', flexDirection:'column', gap:20 }}>
        <p style={{ margin:0 }}>Placeholder for scheduling calendar & approvals.</p>
